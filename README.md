...
I'm deep in the intersection of voice technology, agentic AI, and insurance innovation—building systems that handle the complexity of real-world insurance workflows while delivering seamless user experiences. My work focuses on:

- Conversational and voice AI agents for claims automation
- Agentic applications that transform web experiences
- Agent SDKs for different types of intelligent interactions
